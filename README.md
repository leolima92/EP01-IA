...
* Para cada caixa no mapa, calculamos a distância entre sua posição atual $(linha_c, coluna_c)$ e a posição do alvo mais próximo $(r_a, c_a)$:

$$h(n) = |linha_c - r_a| + |coluna_c - c_a|$$
